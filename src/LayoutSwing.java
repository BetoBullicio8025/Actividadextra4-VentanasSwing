...
public class LayoutSwing extends JFrame {
    ...
    public LayoutSwing(String title) throws HeadlessException {
        super(title);
    ...
    // Panel 1
        ...
        //Panel 2
        String urlImagen = "https://static.wikia.nocookie.net/marvel-contestofchampions/images/9/9a/Star-Lord_portrait.png/revision/latest?cb=20150830075532";
        panel2 = new JPanel();
        panel2.setBackground(new Color(223, 145, 128));
        panel2.setLayout(new FlowLayout());
        //cargar la imagen de internet
        try{
            URL url1 = new URL(urlImagen);
            Image imagen1 = ImageIO.read(url1);
            ImageIcon imagenIcon = new ImageIcon(imagen1);
        ...
        //Panel 3
        panel3 = new JPanel();
        panel3.setBackground(new Color(234, 221, 158));

        panel3.setLayout(new FlowLayout(FlowLayout.RIGHT));
        String[] elementos = {"opcion1", "opcion2", "opcion3", "opcion2"};
        ...
        panel4.setBackground(new Color(139, 98, 133));
